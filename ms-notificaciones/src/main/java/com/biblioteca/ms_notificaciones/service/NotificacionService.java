...
public class NotificacionService {
    ...
    public NotificacionResponseDTO obtenerNotificacionPorId(Long id) {
        ...
        return notificacion != null ? toResponseDTO(notificacion) : null;
    }
    ...
    private NotificacionResponseDTO toResponseDTO(Notificacion notificacion) {
        return new NotificacionResponseDTO(notificacion.getId(), notificacion.getDestinatario(), notificacion.getMensaje());
    }
}