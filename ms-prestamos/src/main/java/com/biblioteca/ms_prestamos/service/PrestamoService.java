...
public class PrestamoService {
    ...
    public PrestamoResponseDTO obtenerPrestamoPorId(Long id) {
        ...
        return prestamo != null ? toResponseDTO(prestamo) : null;
    }
    ...
    private PrestamoResponseDTO toResponseDTO(Prestamo prestamo) {
        return new PrestamoResponseDTO(prestamo.getId(), prestamo.getUsuarioId(), prestamo.getLibroId(), prestamo.getFechaPrestamo());
    }
}