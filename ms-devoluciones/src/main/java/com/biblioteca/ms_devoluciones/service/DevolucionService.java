...
public class DevolucionService {
    ...
    public DevolucionResponseDTO obtenerDevolucionPorId(Long id) {
        Devolucion devolucion = repository.findById(id).orElse(null);
        return devolucion != null ? toResponseDTO(devolucion) : null;
    }
    ...
    private DevolucionResponseDTO toResponseDTO(Devolucion devolucion) {
        return new DevolucionResponseDTO(devolucion.getId(), devolucion.getPrestamoId(), devolucion.getFechaDevolucion());
    }
}